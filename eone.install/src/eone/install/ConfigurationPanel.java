...
public class ConfigurationPanel extends JPanel implements ActionListener, IDBConfigMonitor
{
	...
	//	KeyStore
	private JLabel 		lEONEHome = new JLabel();
	JTextField 	fEONEHome = new JTextField(FIELDLENGTH);
	JCheckBox 	okEONEHome = new JCheckBox();
	...
	private void jbInit() throws Exception
	{
		...
		lEONEHome.setToolTipText(res.getString("AdempiereHomeInfo"));
		lEONEHome.setText(res.getString("AdempiereHome"));
		fEONEHome.setText(".");
		okEONEHome.setEnabled(false);
		...
		this.add(lEONEHome,		new GridBagConstraints(0, 5, 1, 1, 0.0, 0.0,GridBagConstraints.EAST, GridBagConstraints.NONE, new Insets(5, 5, 2, 5), 0, 0));
		this.add(fEONEHome,		new GridBagConstraints(1, 5, 1, 1, 0.5, 0.0,GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(5, 5, 2, 0), 0, 0));
		this.add(okEONEHome,	new GridBagConstraints(2, 5, 1, 1, 0.0, 0.0,GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 0, 2, 5), 0, 0));
	...
	void cleanSignalOk (){
		...
		okEONEHome.setBackground(null);
		okEONEHome.setSelected(false);
