...
public class ConfigurationData
{
	...
	public boolean load()
	{
		...
		if (env.exists())
		{
			...
			//
			setEONEHome((String)p_properties.get(EONE_HOME));
	...
	public String testEnveroment()
	{
		...
		if (p_panel != null)
			p_panel.signalOK(p_panel.okEONEHome, "ErrorEoneHome",
					pass, true, error);
		if (!pass)
			return error;
