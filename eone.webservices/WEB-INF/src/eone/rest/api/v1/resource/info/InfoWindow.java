...
package eone.rest.api.v1.resource.info;
...
public class InfoWindow {
	...
	private void addViewIDToQuery () {
		m_sqlMain = addMoreColumnToQuery (m_sqlMain, null);
	}
	...
	private String buildQuerySQL(int start, int end) {
        ...
        dataSql = MRole.addAccessSQL(dataSql, alias, MRole.SQL_FULLYQUALIFIED, MRole.SQL_RO, Env.getCtx());
