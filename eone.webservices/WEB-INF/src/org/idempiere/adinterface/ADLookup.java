...
public class ADLookup {
	...
	public static String getDirectAccessSQL (Lookup lookup, String text)
	{
		...
		if (sql.length() > 0)
		{
			...
			return MRole.addAccessSQL(sql.toString(), m_tableName, MRole.SQL_NOTQUALIFIED, MRole.SQL_RO, Env.getCtx());
		}
		...
		return MRole.addAccessSQL(retValue.toString(), m_tableName, MRole.SQL_NOTQUALIFIED, MRole.SQL_RO, Env.getCtx());
	}
