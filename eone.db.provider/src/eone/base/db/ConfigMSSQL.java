 ...
 */
public class ConfigMSSQL implements IDatabaseConfig
{

	private final static CLogger log = CLogger.getCLogger(ConfigMSSQL.class);
	...
	private EONEDatabase p_db = Database.getDatabase(Database.DB_MSSQL);
	...
	{
		configurationData.setDatabasePort(String.valueOf(Database.DB_MSSQL_DEFAULT_PORT));
