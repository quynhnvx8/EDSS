...
public class FavouriteController {
	...
	private void init() {
		...
		String adTreeIds = Env.getContext(Env.getCtx(), "#AD_Tree_IDs");
        int AD_Tree_ID = TREE_MENUPRIMARY;
        m_AD_Tree_ID = AD_Tree_ID;
		
        MTree mTree = new MTree(Env.getCtx(), AD_Tree_ID, false, true, null, adTreeIds);      
