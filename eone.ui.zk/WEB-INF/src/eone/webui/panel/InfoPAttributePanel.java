...
public class InfoPAttributePanel extends Window implements EventListener<Event>
{
	...
	public InfoPAttributePanel(Object input)
	{
		...
		if (input != null) {
			if (input instanceof InfoProductPanel) {
				p_M_AttributeSet_ID = 0;//((InfoProductPanel)input).getM_AttributeSet_ID();
	...
	private int addAttributes()
	{
		...
		String sql = MRole.addAccessSQL(
			...
			"M_Attribute", MRole.SQL_NOTQUALIFIED, MRole.SQL_RO, Env.getCtx());
	...
	private void initLotSelection()
	{
		...
		String sql = MRole.addAccessSQL(
			...
			"M_Lot", MRole.SQL_NOTQUALIFIED, MRole.SQL_RO, Env.getCtx());
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try
		{
