...
public class GridView extends Vlayout implements EventListener<Event>, IdSpace, IFieldEditorContainer, StateChangeListener
{
	...
	private static final String ATTR_ON_POST_SELECTED_ROW_CHANGED = "eone.webui.adwindow.GridView.onPostSelectedRowChanged";
	...
	public void init(GridTab gridTab)
	{
		...
		if (listbox.getFrozen() != null){
			listbox.getFrozen().setWidgetOverride("syncScroll", "function (){eone.syncScrollFrozen(this);}");
		}
	...
	private void setupColumns()
	{
		...
		if (showCurrentRowIndicatorColumn)
		{
			...
			//indicator.setStyle("border-bottom: 1px solid #F2F2F2;");
	...
	public boolean onEnterKey() {
		if (!modeless && renderer != null && !renderer.isEditing()) {
			...
			renderer.focusToNextEditor(renderer.currentFocusField);
		}
		return false;
	}
