...
public class WListItemRenderer implements ListitemRenderer<Object>, EventListener<Event>, ListitemRendererExt
{
	...
	protected boolean 		m_zoomable = false;
	protected IZoom 			m_zoomViewer;
	...
	public WListItemRenderer(IZoom viewer, boolean zoomable)
	{
		super();
		m_zoomViewer = viewer;
		m_zoomable = zoomable;
	...
	public WListItemRenderer(IZoom viewer, boolean zoomable, List< ? extends String> columnNames)
	{
		super();
		m_zoomViewer = viewer;
		m_zoomable = zoomable;
