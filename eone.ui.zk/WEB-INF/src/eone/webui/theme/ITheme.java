...
public interface ITheme {
	...
	public static String ZK_COPYRIGHT = " Copyright (C) 2020 - By DSS";
	public static String ZK_TITLE = "eDSS";
	...
	public static String BG_LOGIN = ThemeManager.getThemeResource("images/bgdefault.jpg");
