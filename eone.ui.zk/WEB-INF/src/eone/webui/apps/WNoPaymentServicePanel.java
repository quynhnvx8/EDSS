...
import eone.base.model.MPayment;
...
public class WNoPaymentServicePanel extends Window implements IFormController, EventListener<Event>, WTableModelListener
{
	...
	private void prepareTable()
	{
		...
		m_columns[index++] = new WInfo_Column(Msg.translate(Env.getCtx(), "AmountService"), 	"AmountService",Double.class, 100);
		m_columns[index++] = new WInfo_Column(Msg.translate(Env.getCtx(), "ListService"),		"ListService",String.class, 400);
	...
	private List<Object[]> loadData() {
		...
		String sqlSelect = 
				...
				+" ("
				+ "		SELECT SUM(Amount) "
				+ "		FROM HM_PatientRegisterLine l  "
				+ "		WHERE l.HM_PatientRegister_ID = r.HM_PatientRegister_ID AND l.PerformStatus = 'NU' "
				+ ") AS AmountService, "
				+" ("
				...
				Object [] param = 
					{
							...
							rs.getBigDecimal("AmountService"),
			...
			public void render(Listitem item, Object[] data, int index) throws Exception {
				...
				btn.addActionListener(new EventListener<Event>() {
					...
					public void onEvent(Event event) throws Exception {
						AEnv.zoom(MPayment.Table_ID, Integer.parseInt(data[0].toString()), form.getZoomWindow());
					}
				...
				cell = new ListCell(data[6] == null? "" : data[6].toString());
				item.appendChild(cell);
			}
	...
	private String getSQLWhere()
	{
		...
		StringBuilder whereClause = new StringBuilder(" WHERE ").append(form.getZoomLogic() == null ? " 1=1 " : form.getZoomLogic());
