...
public class WInfo_Column
{
	...
	{
		this(colHeader, colSQL, colClass, true, false, null, 0, null);
	}   //  Info_Column
	
	public WInfo_Column (String colHeader, String colSQL, Class<?> colClass, int width)
	{
		this(colHeader, colSQL, colClass, true, false, null, width, null);
	}
	
	public WInfo_Column (String colHeader, String colSQL, Class<?> colClass, int width, String textAlign)
	{
		this(colHeader, colSQL, colClass, true, false, null, width, textAlign);
	}

	public WInfo_Column (String colHeader, String colSQL, Class<?> colClass, String IDcolSQL)
	{
		this(colHeader, colSQL, colClass, true, false, IDcolSQL, 0, null);
	}   //  Info_Column

	public WInfo_Column (String colHeader, String colSQL, Class<?> colClass, 
		boolean readOnly, boolean colorColumn, String IDcolSQL, int width, String textAlign)
	{
