...
public class WHealthUpdateResultPanel extends ADForm implements IFormController, EventListener<Event>, ValueChangeListener
{
	...
	public WHealthUpdateResultPanel() {
	...
	private void jbInit () throws Exception
	{
		...
		editor.setFilebrowserImageBrowseUrl("img");
		editor.setFilebrowserImageUploadUrl("img");
		editor.setHeight("100px");
		editor.setWidth("100px");
	...
	private boolean saveChange()
	{
		...
		if (listID != null) {
			for( int i = 0; i < listID.length; i++) {
				...
				line.set_ValueNoCheck("CreatedBy", Env.getAD_User_ID(Env.getCtx()));
				line.set_ValueNoCheck("UpdatedBy", Env.getAD_User_ID(Env.getCtx()));
				line.set_ValueNoCheck("Created", new Timestamp(new Date().getTime()));
