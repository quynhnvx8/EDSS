...
public class WSelectHealthCareServices extends ADForm implements IFormController, EventListener<Event>, ValueChangeListener
{
	...
	private Combobox 			productCategory = new Combobox("---------Lựa chọn----------");
	...
	public WSelectHealthCareServices() {
