...
//        	Check if it is a List Reference
    ...
    //Add: 08/09/2021: Bổ sung hàm zoom trường hợp cấu hình từ field
    public static void actionZoom(Lookup lookup, Object value, int AD_Window_ID)
    {
        if (lookup == null)
            return;
        //
