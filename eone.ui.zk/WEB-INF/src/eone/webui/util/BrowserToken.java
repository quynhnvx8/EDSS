...
public final class BrowserToken {
	...
	public static void save(MUser user) {
		try
		{
		    ...
		    String script = "eone.saveUserToken('" + home + "', '" + hash + "', '" + Env.getContext(Env.getCtx(), "#AD_Session_ID") + "');";
	...
	public static void remove() {
		try {
			String home = getHomeToken();
			String script = "eone.removeUserToken('" + home + "');";
			AuScript aus = new AuScript(null, script);
	...
	public static void load(Component component) {
        ...
        {
	        String home = getHomeToken();
			String script = "eone.findUserToken('" + component.getUuid() + "', '" + home + "');";
