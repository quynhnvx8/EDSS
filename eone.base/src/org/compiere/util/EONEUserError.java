 ...
 */
public class EONEUserError extends RuntimeException
{
	/**
	 *
	 */
	 ...
	 */
	public EONEUserError (String message)
	{
		super (message);
	}	//	AdempiereUserError
	 ...
	 */
	public EONEUserError (String message, String fixHint)
	{
		super (message);
		setFixHint(fixHint);
	}	//	AdempiereUserError
	 ...
	 *	@param cause
	 */
	public EONEUserError (String message, Throwable cause)
	{
		super (message, cause);
	}	//	AdempiereUserError
