...
public class CCachedRowSet implements RowSet, Serializable, Cloneable, CachedRowSet
{
	 ...
	 *	@throws SQLException
	 */
	public static RowSet getRowSet (String sql, Connection conn, EONEDatabase db) throws SQLException
	{
	 ...
	 *	@throws SQLException
	 */
	public static RowSet getRowSet (ResultSet rs, EONEDatabase db) throws SQLException
	{
		if (db.getName().equals(Database.DB_ORACLE))
		{
			CachedRowSet crs = RowSetProvider.newFactory().createCachedRowSet();
