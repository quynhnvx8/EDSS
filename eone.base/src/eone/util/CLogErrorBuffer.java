...
{
	private static final String ISSUE_ERROR_KEY = "eone.util.CLogErrorBuffer.issueError";
	private static final String HISTORY_KEY = "eone.util.CLogErrorBuffer.history";
	private static final String ERRORS_KEY = "eone.util.CLogErrorBuffer.errors";
	private static final String LOGS_KEY = "eone.util.CLogErrorBuffer.logs";
