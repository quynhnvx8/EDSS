...
public class WritePDF {
    ...
    public byte[] getPDFAsArray(MPrintFormat m_printFormat, HashMap<String, Object> m_params) {//Pageable pageable, 
        try {
            ByteArrayOutputStream output = new ByteArrayOutputStream(10240);
            writePDF(output, m_printFormat, m_params); 
