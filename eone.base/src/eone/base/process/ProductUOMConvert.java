...
public class ProductUOMConvert extends SvrProcess
{
	...
	protected String doIt () throws Exception
	{
		if (p_M_Product_ID == 0 || p_M_Product_To_ID == 0
			...
			throw new EONEUserError("Invalid Parameter");
		//
		...
		MUOMConvert[] conversions = MUOMConvert.getProductConversions(getCtx(), product.getM_Product_ID());
		MUOMConvert conversion = null;
		...
		if (conversion == null)
			throw new EONEUserError("@NotFound@: @C_UOM_Conversion_ID@");
		...
		if (qtyTo.compareTo(qtyTo6) != 0)
			throw new EONEUserError("@StdPrecision@: " + qtyTo + " <> " + qtyTo6 
