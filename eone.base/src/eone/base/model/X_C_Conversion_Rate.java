...
public class X_C_Conversion_Rate extends PO implements I_C_Conversion_Rate, I_Persistent 
{
	...
	public eone.base.model.I_C_ConversionType getC_ConversionType() throws RuntimeException
    {
		return (eone.base.model.I_C_ConversionType)MTable.get(getCtx(), eone.base.model.I_C_ConversionType.Table_Name)
	...
	public eone.base.model.I_C_Currency getC_Currency_To() throws RuntimeException
    {
		return (eone.base.model.I_C_Currency)MTable.get(getCtx(), eone.base.model.I_C_Currency.Table_Name)
