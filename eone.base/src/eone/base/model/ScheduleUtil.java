...
public class ScheduleUtil
{
		...
		BigDecimal qty, boolean getAll, String trxName)
	{
		...
		m_endDate = end_Date;
		if (m_endDate == null)
			m_endDate = MUOMConvert.getEndDate(m_ctx, m_startDate, m_C_UOM_ID, qty);
	...
	private void getBaseInfo (int S_Resource_ID)
	{
		...
		String sql = MRole.addAccessSQL (
			...
			"r", MRole.SQL_FULLYQUALIFIED, MRole.SQL_RO, m_ctx);
		//
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try
	...
	private void createTimeSlots()
	{
		...
		int minutes = MUOMConvert.convertToMinutes (m_ctx, m_C_UOM_ID, Env.ONE);
