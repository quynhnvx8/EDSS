	...
	public static SetGetModel wrap(Object o)
	{
		...
		else if (o instanceof SetGetModel && !(o instanceof Proxy))
		{
			return (SetGetModel)o;
				...
				&& Proxy.getInvocationHandler(o) instanceof eone.base.model.GridTabWrapper)
		{
			eone.base.model.GridTabWrapper gtw = (eone.base.model.GridTabWrapper)Proxy.getInvocationHandler(o);
