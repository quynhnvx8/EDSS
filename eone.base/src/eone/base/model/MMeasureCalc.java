...
public class MMeasureCalc extends X_PA_MeasureCalc
{
		...
		String MeasureScope, String MeasureDataType, Timestamp reportDate)
	{
		...
		String sql = addRestrictions(sb.toString(), restrictions);
		if (sql.indexOf("@") >= 0)
		...
		String MeasureDisplay, Timestamp date)
	{
		...
		String finalSQL = addRestrictions(sql.toString(), restrictions);
	...
	{
		return addRestrictions(sql, false, restrictions,
	...
	public static String addRestrictions(String sql, boolean queryOnly,
		MGoalRestriction[] restrictions, String tableName, String orgColumn, String bpColumn, String pColumn)
	{
		...
		if (queryOnly)
			return finalSQL;
		String retValue = MRole.addAccessSQL(finalSQL, tableName, true, false, Env.getCtx());
		return retValue;
	}	//	addRestrictions
