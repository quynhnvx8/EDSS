...
// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM C_CashLine WHERE C_Cash_ID=@C_Cash_ID@
	...
	public eone.base.model.I_C_Cash getC_Cash() throws RuntimeException
    {
		return (eone.base.model.I_C_Cash)MTable.get(getCtx(), eone.base.model.I_C_Cash.Table_Name)
