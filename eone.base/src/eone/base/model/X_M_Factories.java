...
/** Generated Model for M_Factories
 *  @author EOne (generated) 
 *  @version Version 1.0 - $Id$ */
public class X_M_Factories extends PO implements I_M_Factories, I_Persistent 
{
    ...
    public X_M_Factories (Properties ctx, int M_Factories_ID, String trxName)
    {
      super (ctx, M_Factories_ID, trxName);
      /** if (M_Factories_ID == 0)
        {
        } */
    }
    ...
    /** Load Constructor */
    public X_M_Factories (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_M_Factories[")
