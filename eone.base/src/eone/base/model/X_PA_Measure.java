...
// M
	...
	public eone.base.model.I_PA_MeasureCalc getPA_MeasureCalc() throws RuntimeException
    {
		return (eone.base.model.I_PA_MeasureCalc)MTable.get(getCtx(), eone.base.model.I_PA_MeasureCalc.Table_Name)
