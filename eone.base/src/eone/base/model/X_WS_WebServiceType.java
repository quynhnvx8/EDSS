...
public class X_WS_WebServiceType extends PO implements I_WS_WebServiceType, I_Persistent 
{
	...
	public eone.base.model.I_WS_WebService getWS_WebService() throws RuntimeException
    {
		return (eone.base.model.I_WS_WebService)MTable.get(getCtx(), eone.base.model.I_WS_WebService.Table_Name)
	...
	public eone.base.model.I_WS_WebServiceMethod getWS_WebServiceMethod() throws RuntimeException
    {
		return (eone.base.model.I_WS_WebServiceMethod)MTable.get(getCtx(), eone.base.model.I_WS_WebServiceMethod.Table_Name)
