...
public class X_AD_Note extends PO implements I_AD_Note, I_Persistent 
{
	...
	public eone.base.model.I_AD_BroadcastMessage getAD_BroadcastMessage() throws RuntimeException
    {
		return (eone.base.model.I_AD_BroadcastMessage)MTable.get(getCtx(), eone.base.model.I_AD_BroadcastMessage.Table_Name)
	...
	public eone.base.model.I_AD_Message getAD_Message() throws RuntimeException
    {
		return (eone.base.model.I_AD_Message)MTable.get(getCtx(), eone.base.model.I_AD_Message.Table_Name)
