...
public class X_WS_WebServiceFieldOutput extends PO implements I_WS_WebServiceFieldOutput, I_Persistent 
{
	...
	public eone.base.model.I_WS_WebServiceType getWS_WebServiceType() throws RuntimeException
    {
		return (eone.base.model.I_WS_WebServiceType)MTable.get(getCtx(), eone.base.model.I_WS_WebServiceType.Table_Name)
