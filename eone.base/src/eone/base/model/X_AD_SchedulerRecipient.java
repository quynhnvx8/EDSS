...
public class X_AD_SchedulerRecipient extends PO implements I_AD_SchedulerRecipient, I_Persistent 
{
	...
	public eone.base.model.I_AD_Scheduler getAD_Scheduler() throws RuntimeException
    {
		return (eone.base.model.I_AD_Scheduler)MTable.get(getCtx(), eone.base.model.I_AD_Scheduler.Table_Name)
