...
public class X_AD_AlertRecipient extends PO implements I_AD_AlertRecipient, I_Persistent 
{
	...
	public eone.base.model.I_AD_Alert getAD_Alert() throws RuntimeException
    {
		return (eone.base.model.I_AD_Alert)MTable.get(getCtx(), eone.base.model.I_AD_Alert.Table_Name)
