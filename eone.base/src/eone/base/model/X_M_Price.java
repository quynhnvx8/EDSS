...
/** Generated Model for M_Price
 *  @author EOne (generated) 
 *  @version Version 1.0 - $Id$ */
public class X_M_Price extends PO implements I_M_Price, I_Persistent 
{
    ...
    public X_M_Price (Properties ctx, int M_Price_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_M_Price (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_M_Price[")
	...
	/** Set Price.
		@param M_Price_ID Price	  */
	public void setM_Price_ID (int M_Price_ID)
	{
		if (M_Price_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_M_Price_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_M_Price_ID, Integer.valueOf(M_Price_ID));
	}

	/** Get Price.
		@return Price	  */
	public int getM_Price_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_M_Price_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_PriceSO, PriceSO);
	}
