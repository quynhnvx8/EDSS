...
public class X_M_PackageLine extends PO implements I_M_PackageLine, I_Persistent 
{
	...
	public eone.base.model.I_M_InOutLine getM_InOutLine() throws RuntimeException
    {
		return (eone.base.model.I_M_InOutLine)MTable.get(getCtx(), eone.base.model.I_M_InOutLine.Table_Name)
	...
	public eone.base.model.I_M_Package getM_Package() throws RuntimeException
    {
		return (eone.base.model.I_M_Package)MTable.get(getCtx(), eone.base.model.I_M_Package.Table_Name)
