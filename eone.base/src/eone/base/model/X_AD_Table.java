...
// L
	...
	/** Set IsUniqueValue.
		@param IsUniqueValue IsUniqueValue	  */
	public void setIsUniqueValue (boolean IsUniqueValue)
	{
		set_Value (COLUMNNAME_IsUniqueValue, Boolean.valueOf(IsUniqueValue));
	}
	...
	{
		Object oo = get_Value(COLUMNNAME_IsUniqueValue);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public eone.base.model.I_AD_Window getPO_Window() throws RuntimeException
    {
		return (eone.base.model.I_AD_Window)MTable.get(getCtx(), eone.base.model.I_AD_Window.Table_Name)
