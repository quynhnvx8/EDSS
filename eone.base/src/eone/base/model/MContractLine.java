 ...
 */
public class MContractLine extends X_C_ContractLine
{
	/**
	 * 
	 */
	 ...
	 */
	public MContractLine (Properties ctx, int C_ContractLine_ID, String trxName)
	{
	 ...
	 */
	public MContractLine (MContract contract)
	{
		this (contract.getCtx(), 0, contract.get_TrxName());
		setC_Contract_ID (contract.getC_Contract_ID());	// Parent
		setLineNo();
	}	//	MProjectLine

	/** Parent				*/
	private MContract	m_parent = null;
	...
	{
		if (m_parent == null && getC_Contract_ID() != 0)
		{
			m_parent = new MContract (getCtx(), getC_Contract_ID(), get_TrxName());
			if (get_TrxName() != null)
