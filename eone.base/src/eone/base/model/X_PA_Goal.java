...
// 1
    ...
    {
		return (eone.base.model.I_AD_Role)MTable.get(getCtx(), eone.base.model.I_AD_Role.Table_Name)
	...
	public eone.base.model.I_PA_ColorSchema getPA_ColorSchema() throws RuntimeException
    {
		return (eone.base.model.I_PA_ColorSchema)MTable.get(getCtx(), eone.base.model.I_PA_ColorSchema.Table_Name)
	...
	public eone.base.model.I_PA_Goal getPA_GoalParent() throws RuntimeException
    {
		return (eone.base.model.I_PA_Goal)MTable.get(getCtx(), eone.base.model.I_PA_Goal.Table_Name)
	...
	public eone.base.model.I_PA_Measure getPA_Measure() throws RuntimeException
    {
		return (eone.base.model.I_PA_Measure)MTable.get(getCtx(), eone.base.model.I_PA_Measure.Table_Name)
