...
/** Generated Model for HM_Province
 *  @author EOne (generated) 
 *  @version Version 1.0 - $Id$ */
public class X_HM_Province extends PO implements I_HM_Province, I_Persistent 
{
    ...
    public X_HM_Province (Properties ctx, int HM_Province_ID, String trxName)
    {
      super (ctx, HM_Province_ID, trxName);
      /** if (HM_Province_ID == 0)
        {
			setName (null);
			setValue (null);
    ...
    /** Load Constructor */
    public X_HM_Province (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuilder sb = new StringBuilder ("X_HM_Province[")
