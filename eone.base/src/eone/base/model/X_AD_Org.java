...
public class X_AD_Org extends PO implements I_AD_Org, I_Persistent 
{
	...
	public eone.base.model.I_C_SalesRegion getC_SalesRegion() throws RuntimeException
    {
		return (eone.base.model.I_C_SalesRegion)MTable.get(getCtx(), eone.base.model.I_C_SalesRegion.Table_Name)
	...
	/** Set Create Warehouse.
		@param IsCreateWarehouse Create Warehouse	  */
	public void setIsCreateWarehouse (boolean IsCreateWarehouse)
	{
		set_Value (COLUMNNAME_IsCreateWarehouse, Boolean.valueOf(IsCreateWarehouse));
	}

	/** Get Create Warehouse.
		@return Create Warehouse	  */
	public boolean isCreateWarehouse () 
	{
		Object oo = get_Value(COLUMNNAME_IsCreateWarehouse);
		if (oo != null) 
		{
			 if (oo instanceof Boolean) 
				 return ((Boolean)oo).booleanValue(); 
	...
	public eone.base.model.I_HR_Employee getSupervisor() throws RuntimeException
    {
