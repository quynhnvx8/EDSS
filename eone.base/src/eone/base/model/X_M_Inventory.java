...
// @#Date@
	...
	public eone.base.model.I_M_Inventory getReversal() throws RuntimeException
    {
		return (eone.base.model.I_M_Inventory)MTable.get(getCtx(), eone.base.model.I_M_Inventory.Table_Name)
